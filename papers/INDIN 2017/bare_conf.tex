...
%TODO In den Experimenten ist nicht beschrieben, welche Werte für die Parameter für Hypothesentest und ICE verwendet wurde. Das heißt, es muss da stehen wie $k$ (in Gleichung (5)), $d$ (aus Schritt 1 von RANSAC), $k$ (aus Schritt 2 von RANSAC. BTW: wir haben hier zwei versch. Parameter mit dem Symbol $k$), $q$ (Anzahl Wiederholungen von RANSAC) in den Experimenten gesetzt wurden. Das kann man beispielsweise in einer Tabelle machen.
